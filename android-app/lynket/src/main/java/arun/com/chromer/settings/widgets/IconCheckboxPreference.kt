 ...
 * icon frame and icon itself so that it looks better. Supports hiding the checkbox widget.
 */
class IconCheckboxPreference @JvmOverloads constructor(
    context: Context,
    ...
    private var hideCheckbox = false

    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        super.onBindViewHolder(holder)
        PreferenceIconLayoutHelper.applyLayoutChanges(holder, isEnabled)
        val checkboxView = holder.findViewById(androidx.preference.R.id.checkbox)
